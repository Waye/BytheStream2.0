  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bgCanvas }}>
      ...
      >
        ...
        <View style={{
          padding: isMobile ? spacing.xl : 40,
          ...
          <Text style={{
            textAlign: 'center', fontSize: fontSize.body,
            color: theme.textSecondary, marginTop: 8, marginBottom: spacing.xl,
          }}>登录后可同步你的收藏、阅读进度与播放队列</Text>
          ...
          <TextInput
            ...
            style={{
              ...
              paddingVertical: 12, fontSize: fontSize.body,
          ...
          >
            <Text style={{ color: theme.onBrand, fontSize: fontSize.body, fontWeight: '600' }}>
              登录
            </Text>
          </Pressable>
          ...
          <View style={{
            ...
            <Text style={{
              ...
              color: theme.textMuted, fontSize: fontSize.caption,
            }}>或使用第三方登录</Text>
            <View style={{ flex: 1, height: 1, backgroundColor: theme.borderSoft }}/>
          </View>
          ...
          <Text style={{
            ...
            fontSize: fontSize.small, color: theme.textSecondary,
          }}>
            还没有账号?{' '}
            <Text style={{ color: theme.brand, fontWeight: '600' }}>免费注册</Text>
          </Text>
        </View>
      </ScrollView>
    </View>
...
function OAuthBtn({ label, onPress }: { label: string; onPress: () => void }) {
  ...
  return (
    <Pressable
      onPress={onPress}
      style={({ pressed }) => ({
        flex: 1, padding: 11, borderRadius: 14,
        borderWidth: 1, borderColor: theme.border,
        backgroundColor: pressed ? theme.bgSurface : theme.bgCanvas,
        alignItems: 'center',
      })}
    >
      <Text style={{ fontSize: fontSize.small, fontWeight: '600', color: theme.textPrimary }}>
        {label}
      </Text>
    </Pressable>
  );
